...
const FourCards = ({ bgImage, category, title, author, avatar, date }) => {
  ...
  return (
    <>
      ...
      <article
        className="h-[500px] cursor-pointer group relative overflow-hidden w-1/4"
      ...
      >
        ...
        {/* <div className="flex flex-col absolute top-[75%] group-hover:top-[68%] h-full w-full"> */}
        ...
        <div className="flex flex-col h-full w-full absolute top-[75%] group-hover:top-[65%] gap-4 text-akpica-white p-4 bg-akpica-black/70 to-akpica-white/5 group-hover:bg-akpica-black">
          ...
          <div className="">
            ...
            <button className="text-white mt-5 px-3 py-1 bg-akpica-carlo hover:bg-akpica-green group-hover:mt-4 transition group-hover:delay-700 duration-300 ease-in-out">
              See more
            </button>
          </div>
        </div>
